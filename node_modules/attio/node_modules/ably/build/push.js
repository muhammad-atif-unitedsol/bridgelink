...
Released under the Apache Licence v2.0*/(function (g, f) {
    if ("object" == typeof exports && "object" == typeof module) {
      module.exports = f(require('ulid'));
    } else if ("function" == typeof define && define.amd) {
      define(['ulid'], f);
    } else if ("object" == typeof exports) {
      exports["AblyPushPlugin"] = f(require('ulid'));
    } else {
      g["AblyPushPlugin"] = f(g["ulid"]);
    }
  }(this, (__da) => {
var exports = {};
var module = { exports };
...
function localDeviceFactory(deviceDetails) {
  return class LocalDevice extends deviceDetails {
    ...
    async listSubscriptions() {
      ...
      if (!this.id) {
        throw new this.rest.ErrorInfo("Device not activated", 4e4, 400);
      }
    ...
    loadPersisted() {
      ...
      if (this.id) {
        this.deviceSecret = Platform2.Config.push.storage.get(persistKeys.deviceSecret);
